...
function eml_aff_formulaire($erreurs) {
    ...
    echo
        ...
        '<section>',
            ...
            '<form action="inscription_5.php" method="post">';
    ...
    echo '<table>',
            '<tr>', 
                ...
                '<td><input type="text" name="pseudo" id="txtPseudo" value="', $pseudo, '" placeholder="4 caractères minimum" required></td>', 
            '</tr>',
            '<tr>',
                '<td>Votre civilité :</td>',
                '<td>',
                    '<label><input type="radio" name="radSexe" value="1"', ($civilite == 1 ? ' checked' : ''), ' required> Monsieur</label>',
                    '<input type="radio" name="radSexe" id="radio2" value="2"', ($civilite == 2 ? ' checked' : ''), ' required> <label for="radio2">Madame</label>',
                '</td>',
            '</tr>',
            '<tr>', 
                '<td><label for="txtNom">Votre nom :</label></td>',
                '<td><input type="text" name="nom" id="txtNom" value="', $nom, '" required></td>', 
            '</tr>',
            '<tr>', 
                '<td><label for="txtPrenom">Votre prénom :</label></td>',
                '<td><input type="text" name="prenom" id="txtPrenom" value="', $prenom, '" required></td>', 
            '</tr>',
            '<tr>', 
                '<td>Votre date de naissance :</td>',
                '<td>';
    em_aff_liste_nombre('naissance_j', 1, 31, 1, $jour);
    em_aff_liste_mois('naissance_m', $mois);
    em_aff_liste_nombre('naissance_a', $anneeCourante - NB_ANNEE_DATE_NAISSANCE + 1, $anneeCourante, -1, $annee);
    echo '</td>', 
            '</tr>',
            '<tr>', 
                '<td><label for="txtEmail">Votre email :</label></td>',
                '<td><input type="email" name="email" id="txtEmail" value="', $email, '" required></td>', 
            '</tr>',
            '<tr>',
                '<td><label for="txtPassword1">Choisissez un mot de passe :</label></td>',
                '<td><input type="password" name="passe1" id="txtPassword1" required></td>',
            '</tr>',
            '<tr>',
            ...
            '<tr>',
                '<td colspan="2">',
                    ...
                    '<label><input type="checkbox" name="cbSpam" value="1"', $mails_pourris ? ' checked>' : '>',
