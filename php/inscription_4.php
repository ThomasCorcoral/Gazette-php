...
function eml_aff_formulaire($erreurs) {
    ...
    if (isset($_POST['btnInscription'])){
        ...
        $mails_pourris = (isset($_POST['cbSpam'])) ? ' checked' : '';
    }
    else{
    ...
    echo
        ...
        '<section>',
            ...
            '<form action="inscription_4.php" method="post">';
    ...
    echo '<table>',
            '<tr>', 
                ...
                '<td><input type="text" name="pseudo" id="txtPseudo" value="', $pseudo, '" placeholder="4 caractères minimum"></td>', 
            '</tr>',
            '<tr>',
                '<td>Votre civilité :</td>',
                '<td>',
                    '<label><input type="radio" name="radSexe" value="1"', ($civilite == 1 ? ' checked' : ''), '> Monsieur</label>',
                    '<input type="radio" name="radSexe" id="radio2" value="2"', ($civilite == 2 ? ' checked' : ''), '> <label for="radio2">Madame</label>',
                '</td>',
            '</tr>',
            '<tr>', 
    ...
    echo '</td>', 
            ...
            '<tr>', 
                ...
                '<td><input type="email" name="email" id="txtEmail" value="', $email, '"></td>', 
            '</tr>',
            '<tr>',
            ...
            '<tr>',
                '<td colspan="2">',
                    ...
                    '<label><input type="checkbox" name="cbSpam" value="1"', $mails_pourris, '>',
